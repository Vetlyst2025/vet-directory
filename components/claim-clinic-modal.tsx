        ...
        {success ? (
          <div className="py-8 text-center space-y-4">
            ...
            <p className="text-slate-600">
              WeWeWeWe'llapos;llapos;ll reviewapos;ll review your claim and contact you at {formData.claimantEmail} within 1-2 business days.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-slate-700">
              ...
              <ul className="space-y-1 list-disc list-inside">
                <li>WeWeWeWe'llapos;llapos;ll reviewapos;ll review your claim within 1-2 business days</li>
